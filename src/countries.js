...
function Cont() {
  ...
  const [selected, setSelected] = useState('IN')
    ...
    useEffect(() => {
      document.getElementById('tw').innerHTML = `<h2>${countryArr[selected]}</h2>`;
      apiii(selected);
    });
    ...
    return (
      <div id="App">
        <div className="select-container">
          <select selected={selected} onChange={(e)=>{
            const selectedcont=e.target.value;
            setSelected(selectedcont);
          }}>
            {options.map((option) => (
